...
namespace Linkofy.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,clientN,webPage,contactEmail,contactName,monthlyQuota,MJTopicsID,UserTableID")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,clientN,webPage,contactEmail,contactName,monthlyQuota,MJTopicsID,UserTableID")] Client client)
        {
            if (ModelState.IsValid)
            {
